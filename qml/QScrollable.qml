...
Item {
	...
	property real leftPadding: Math.max(horizontalPadding, App.safeMarginLeft)
	property real rightPadding: Math.max(horizontalPadding, App.safeMarginRight)
	property real topPadding: Math.max(verticalPadding, App.safeMarginTop)
	property real bottomPadding: Math.max(verticalPadding, App.safeMarginBottom)
